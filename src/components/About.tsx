        ...
        <div className="flex flex-col lg:flex-row gap-20 items-center">
          ...
          >
            <div className="relative group">
              ...
              >
                <p className="text-4xl font-display font-bold text-red-600">০৫+</p>
                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">বছরের অভিজ্ঞতা</p>
              </motion.div>
            </div>
          </motion.div>
          ...
          <div className="lg:w-7/12">
            ...
            >
              <div className="inline-flex items-center gap-2 mb-8 text-red-600">
                ...
                <span className="font-bold uppercase tracking-widest text-xs">আমাদের কথা</span>
              </div>

              <h2 className="text-5xl md:text-7xl font-display font-bold text-slate-900 mb-10 leading-tight">
                সৃজনশীলতা এবং <br />
                প্রযুক্তিগত <span className="text-red-600">নিখুঁততা।</span>
              </h2>

              <p className="text-xl font-medium text-slate-500 mb-12 max-w-2xl">
                উদ্যোক্তা স্টুডিওতে আমরা কেবল ওয়েবসাইট তৈরি করি না, আমরা একটি ডিজিটাল পরিচিতি গড়ি যা আপনার ব্যবসাকে প্রতিযোগিতায় এগিয়ে রাখে। আমাদের প্রতিটি ধাপে থাকে স্বচ্ছতা ও পরম যত্ন।
              </p>
            </motion.div>
            ...
            <div className="grid sm:grid-cols-3 gap-8">
              {values.map((item, i) => (
                <motion.div 
                  ...
                  whileHover={{ backgroundColor: "rgba(255, 255, 255, 1)", boxShadow: "0 20px 25px -5px rgb(0 0 0 / 0.1)" }}
